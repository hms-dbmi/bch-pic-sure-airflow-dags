...
with DAG( "STAGE_CUSTOM_DMP_FILES",
          description="Stage Custom DMP Files",
    ...
    t_stage_custom_dmp_files = PythonOperator(
        task_id="stage_custom_dmp_files",
        python_callable=stage_custom_dmp_files,
        provide_context=True,
        dag=dag,
    )    
    ...
    t_check_pipeline >> t_pipeline_check_passed >> t_stage_custom_dmp_files >> t_end_pipeline 
